reportextension 50137 StdSalesCreditMemoReportExt extends "Standard Sales - Credit Memo"
{
    dataset
    {
        add(Header)
        {
            ...
            column(ExonérationText; GetExonerationText(TotalAmountVAT)) { }
            column(FraisPort; GetFraisDePort("No.")) { }
        }
        add(Line)
        {
